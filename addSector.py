    ...
    for url in urls:
        ...
        if overview:
            ...
            if "oil" in text and "chemical" in text:
                return "OIL-TO-CHEMICALS"
            # Add more fallbacks as needed, e.g.:
            if "bank" in text:
                return "Banking"
            if "telecom" in text or "airtel" in text:
                return "Telecommunications"
            if "it" in text and "services" in text:
                return "IT services"
        # Additional fallback: Look for meta or title hints
